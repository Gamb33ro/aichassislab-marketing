const PATHS = [
  ...
  },
  {
    ...
    proof: "200 users at $25/month. After the platform fee and typical API costs, that's $22,000–$36,000 in net annual revenue — from content you already created. Model your exact numbers with the calculator below.",
