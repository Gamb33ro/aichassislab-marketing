...
const FEATURES: Feature[] = [
  ...
  },
  {
    ...
    tooltip: 'Structured assessment modules: quizzes, guided frameworks, and progress tracking built into the AI.',
    prototype: false,
    build: false,
    production: true,
  },
  {
    name: 'Custom modules',
    tooltip: 'Bespoke interactive modules built specifically for your use case (up to 3 in Production).',
    prototype: false,
    build: false,
    production: 'Up to 3',
  },
